...
<html>
<head>
    <title>分享给你身边的人</title>
    <link type="text/css" rel="stylesheet" href="static/css/friend.css"/>
    <script type="text/javascript" src="static/js/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="static/js/shareFriend.js"></script>
</head>
    ...
    <div class="middle_1 ">
        <div align="center" class="z1" style="height: 550px;margin:0 auto;position: relative">
            ...
            <form id="thisform">
                ...
                <button type="button" style="position:absolute;right:120px;top:220px; " onclick="sendNews()">分享</button>
            </form>
        </div>
    </div>
</div>
